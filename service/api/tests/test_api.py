...
class Tests(TransactionTestCase):
    ...
    def test_appointment_list(self):
        ...
        appointment = Appointment.objects.create(date_time="2021-02-02 03:20", reason="reason code 1", vin="2222", customer="Warren Longmire", technician=tech)
